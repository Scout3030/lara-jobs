        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group date" id="datetimepicker">
                        <input id="deadline" type="text" class="form-control" name="deadline" autocomplete="off" value="{{ old('deadline') ?? now()->add(1, 'day')->format('m/d/Y') }}">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <input id="vacancies" class="form-control" type="number" name="vacancies" autocomplete="off" required min="1" value="{{ old('vacancies') ?? 1 }}">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control editor" rows="5">{{ old('description') }}</textarea>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="form-group">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <textarea id="how_to_apply" name="how_to_apply" class="form-control editor" rows="2">{{ old('how_to_apply') }}</textarea>
                </div>
            </div>
        </div>
        <div class="row">
