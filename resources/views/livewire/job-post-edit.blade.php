        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input id="title" class="form-control" type="text" name="title" autocomplete="off" required value="{{ old('title') ?? $jobPost->title }}">
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select id="job_type_id" name="job_type_id" required>
                        @foreach(\App\Models\JobType::get() as $jobType)
                            <option value="{{$jobType->id}}" @if(old('job_type_id') == $jobType->id ?? $jobPost->job_type_id == $jobType->id) selected @endif>{{$jobType->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group date" id="datetimepicker">
                        <input id="deadline" type="text" class="form-control" name="deadline" autocomplete="off" value="{{ old('deadline') ?? $jobPost->deadline->format('m/d/Y') }}">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <input id="salary" class="form-control" type="text" name="salary" autocomplete="off" placeholder="USD" value="{{ old('salary') ?? $jobPost->salary }}">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    <label for="vacancies">{{__('Vacancies')}}*</label>
                    <input id="vacancies" class="form-control" type="number" name="vacancies" autocomplete="off" required min="1" value="{{ old('vacancies') ?? $jobPost->vacancies }}">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <label for="technologies">{{__('Required Technologies')}}*</label>
                    <p>
